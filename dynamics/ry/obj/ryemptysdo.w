...
&Scoped-define INTERNAL-TABLES gsc_security_control

/* Definitions for QUERY Query-Main                                     */
&Scoped-Define ENABLED-FIELDS 
&Scoped-Define DATA-FIELDS  cEmptyField
&Scoped-Define MANDATORY-FIELDS 
&Scoped-Define APPLICATION-SERVICE 
&Scoped-Define ASSIGN-LIST 
&Scoped-Define DATA-FIELD-DEFS "ry/obj/ryemptysdo.i"
&Scoped-define QUERY-STRING-Query-Main FOR EACH gsc_security_control NO-LOCK INDEXED-REPOSITION
{&DB-REQUIRED-START}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH gsc_security_control NO-LOCK INDEXED-REPOSITION.
{&DB-REQUIRED-END}
&Scoped-define TABLES-IN-QUERY-Query-Main gsc_security_control
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main gsc_security_control
...
DEFINE QUERY Query-Main FOR 
      gsc_security_control SCROLLING.
&ANALYZE-RESUME
{&DB-REQUIRED-END}
...
"?" "cEmptyField" ? "x(8)" "character" ? ? ? ? ? ? no ? no 8 no
