...
rowObject.object_description rowObject.object_type_code ~
rowObject.object_type_description rowObject.template_smartobject ~
rowObject.product_module_code rowObject.product_module_description 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTableWin _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      ...
      rowObject.object_type_description FORMAT "X(35)":U WIDTH 30
      rowObject.template_smartobject FORMAT "YES/NO":U
      rowObject.product_module_code FORMAT "X(10)":U
      rowObject.product_module_description FORMAT "X(35)":U WIDTH 30
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"rowObject.object_filename" ? ? "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" ""
     _FldNameList[2]   > _<SDO>.rowObject.object_description
"rowObject.object_description" ? ? "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" ""
     _FldNameList[3]   = _<SDO>.rowObject.object_type_code
     _FldNameList[4]   > _<SDO>.rowObject.object_type_description
"rowObject.object_type_description" ? ? "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" ""
     _FldNameList[5]   = _<SDO>.rowObject.template_smartobject
     _FldNameList[6]   = _<SDO>.rowObject.product_module_code
     _FldNameList[7]   > _<SDO>.rowObject.product_module_description
"rowObject.product_module_description" ? ? "character" ? ? ? ? ? ? no ? no no "30" yes no no "U" "" ""
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE getcontainedobjectname bTableWin 
PROCEDURE getcontainedobjectname :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
ASSIGN pcObjectName = rowobject.OBJECT_filename:SCREEN-VALUE IN BROWSE br_table
       pcObjectDesc = rowobject.OBJECT_description:SCREEN-VALUE IN BROWSE br_table.
