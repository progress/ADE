...
DEFINE VARIABLE gcBaseTitle    AS CHARACTER  NO-UNDO INIT 'Pro*Spy Plus'.
...
&Scoped-Define ENABLED-OBJECTS detailRect btnResults RECT-19 statusRect ~
btnStart btnStop btnMark btnFilter edParms filterBrowse fiStatement ~
fiProcEvent fiStLoc fiTarget fiSourceFile txtParms fiStatus 
...
DEFINE SUB-MENU m_Tools 
       MENU-ITEM m_Start        LABEL "Start Tracing"
       MENU-ITEM m_Stop         LABEL "Stop Tracing"
       RULE
...
ON END-ERROR OF C-Win /* Pro*Spy Plus */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Pro*Spy Plus */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-RESIZED OF C-Win /* Pro*Spy Plus */
DO:
...
ON CHOOSE OF MENU-ITEM m_Start /* Start Tracing */
DO:
...
ON CHOOSE OF MENU-ITEM m_Stop /* Stop Tracing */
DO:
  APPLY 'CHOOSE' TO btnStop {&M}.
END.
